...
Args:
  ...
  - rateId (string): Rate ID from a prior OptionInfo search. Optional.
  ...
  - roomConfigs (array): Room configurations for multi-room bookings. Alternative to adults/children/infants.
...
Returns:
  JSON with BookingId, Ref, ServiceLineId, and optionally full booking details if returnBookingDetails=true.`,
      inputSchema: z.object({
        ...
        rateId: z.string().optional().describe("Rate ID from prior OptionInfo search"),
